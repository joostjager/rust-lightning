...
/// they can be found.
#[rustfmt::skip]
fn calculate_blinded_path_intro_points<'a, L: Deref<Target = dyn Logger + MaybeSend + MaybeSync>>(
...
#[rustfmt::skip]
pub fn find_routeL: Deref<Target = dyn Logger + MaybeSend + MaybeSync>> GL: Deref, S: ScoreLookUp>(
...
#[rustfmt::skip]
pub(crate) fn get_routeL: Deref<Target = dyn Logger + MaybeSend + MaybeSync>> S: ScoreLookUp>(
...
#[rustfmt::skip]
pub fn build_route_from_hopsL: Deref<Target = dyn Logger + MaybeSend + MaybeSync>> GL: Deref<Target = dyn Logger + MaybeSend + MaybeSync>>(
...
#[rustfmt::skip]
fn build_route_from_hops_internal<L: Deref<Target = dyn Logger + MaybeSend + MaybeSync>>(
	our_node_pubkey: &PublicKey, hops: &[PublicKey], route_params: &RouteParameters,
	network_graph: &ReadOnlyNetworkGraph, logger: L, random_seed_bytes: &[u8; 32],
) -> Result<Route, &'static str> where  {
