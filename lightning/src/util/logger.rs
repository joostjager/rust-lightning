...
pub type LoggerTarget<'a> = dyn Logger + MaybeSend + MaybeSync + 'a;

pub trait LoggerPtr<'a>: Deref<Target = LoggerTarget<'a>> + MaybeSend + MaybeSync {}
impl<'a, T> LoggerPtr<'a> for T where T: Deref<Target = LoggerTarget<'a>> + MaybeSend + MaybeSync {}
...
pub struct WithContext<'a, L: LoggerPtr<'a>> {
...
impl<'a, L: LoggerPtr<'a>> Logger for WithContext<'a, L> {
...
impl<'a, L: LoggerPtr<'a>> WithContext<'a, L> {
