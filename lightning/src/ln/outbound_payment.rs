...
use crate::util::logger::{Logger, LoggerPtr};use crate::util::ser::ReadableArgs;
#[cfg(feature = "std")]
...
pub(super) struct OutboundPayments<L: LoggerPtr> {
...
impl<L: LoggerPtr> OutboundPayments<L> {
	pub(super) fn new(
