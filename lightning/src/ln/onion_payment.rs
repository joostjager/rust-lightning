...
#[rustfmt::skip]
pub fn peel_payment_onion<NS: Deref, L: LoggerPtr, T: secp256k1::Verification>(
...
#[rustfmt::skip]
pub(super) fn decode_incoming_update_add_htlc_onion<NS: Deref, L: LoggerPtr, T: secp256k1::Verification>(
	msg: &msgs::UpdateAddHTLC, node_signer: NS, logger: L, secp_ctx: &Secp256k1<T>,
