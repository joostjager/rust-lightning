...
fn build_unencrypted_failure_packet(
	...
	let mut packet = OnionErrorPacket { data, attribution_data: None };
...
fn update_attribution_data(
	...
	attribution_data.hold_times[0] = hold_time;
...
pub type TruncatedHmac = [u8; HMAC_LEN];

#[derive(Clone, Debug, Hash, PartialEq, Eq)]
pub struct AttributionData {
	pub hold_times: [u32; MAX_HOPS],
	pub hmacs: [TruncatedHmac; HMAC_COUNT],
}

impl AttributionData {
	pub fn new() -> Self {
		Self { hold_times: [0; MAX_HOPS], hmacs: [[0; 4]; HMAC_COUNT] }
	}
}
