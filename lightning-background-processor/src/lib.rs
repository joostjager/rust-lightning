...
/// This is not exported to bindings users as the bindings concretize everything and have constructors for us
impl<'a, R: Deref<Target = RapidGossipSync<G, L>>, G: Deref<Target = NetworkGraph<L>>, L: LoggerPtr>
	GossipSync<
...
fn handle_network_graph_update<L: LoggerPtr>(network_graph: &NetworkGraph<L>, event: &Event) {
