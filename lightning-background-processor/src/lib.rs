...
/// This is not exported to bindings users as the bindings concretize everything and have constructors for us
impl<'a, R: Deref<Target = RapidGossipSync<G, L>>, G: Deref<Target = NetworkGraph<L>>, L: Deref<Target = LoggerTarget>>
	GossipSync<
...
/// This is not exported to bindings users as the bindings concretize everything and have constructors for us
impl<'a, L: Deref<Target = LoggerTarget>>
	GossipSync<
...
fn handle_network_graph_update<L: Deref<Target = LoggerTarget>>(network_graph: &NetworkGraph<L>, event: &Event) {
