...
pub struct SpvClient<'a, P: Poll, C: Cache, L: LoggerPtr>
where
...
impl<'a, P: Poll, C: Cache, L: LoggerPtr> SpvClient<'a, P, C, L>
where
	L::Target: chain::Listen,
{
...
pub struct ChainNotifier<'a, C: Cache, L: LoggerPtr>
where
	L::Target: chain::Listen,
{
...
impl<'a, C: Cache, L: LoggerPtr> ChainNotifier<'a, C, L>
where
	L::Target: chain::Listen,
{
