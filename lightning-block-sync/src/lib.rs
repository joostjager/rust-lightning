...
pub struct SpvClient<'a, P: Poll, C: Cache, L: Deref<Target = dyn Logger + MaybeSend + MaybeSync>>
where
...
impl<'a, P: Poll, C: Cache, L: Deref<Target = dyn Logger + MaybeSend + MaybeSync>>
	SpvClient<'a, P, C, L>
where
	L::Target: chain::Listen,
{
...
pub struct ChainNotifier<'a, C: Cache, L: Deref<Target = dyn Logger + MaybeSend + MaybeSync>>
where
	L::Target: chain::Listen,
{
...
impl<'a, C: Cache, L: Deref<Target = dyn Logger + MaybeSend + MaybeSync>> ChainNotifier<'a, C, L>
where
	L::Target: chain::Listen,
{
