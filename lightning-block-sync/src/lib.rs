...
pub struct SpvClient<'a, P: Poll, C: Cache, L: Deref<Target = LoggerTarget>>
where
...
impl<'a, P: Poll, C: Cache, L: Deref<Target = LoggerTarget>> SpvClient<'a, P, C, L>
where
	L::Target: chain::Listen,
{
...
pub struct ChainNotifier<'a, C: Cache, L: Deref<Target = LoggerTarget>>
where
	L::Target: chain::Listen,
{
...
impl<'a, C: Cache, L: Deref<Target = LoggerTarget>> ChainNotifier<'a, C, L>
where
	L::Target: chain::Listen,
{
