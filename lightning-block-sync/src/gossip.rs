...
impl<S: FutureSpawner, Blocks: Deref + Send + Sync + Clone, L: LoggerPtr + Send + Sync>
...
impl<S: FutureSpawner, Blocks: Deref + Send + Sync + Clone, L: LoggerPtr + Send + Sync> Deref
...
impl<S: FutureSpawner, Blocks: Deref + Send + Sync + Clone, L: LoggerPtr + Send + Sync> UtxoLookup
	for GossipVerifier<S, Blocks, L>
where
	Blocks::Target: UtxoSource,
{
